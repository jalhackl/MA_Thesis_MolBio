...
Different architectures are termed MPNN, the central property is that the perform a message passing and a readout step.
...
A message passing algorithm also using bond information, termed directed MPNN (D-MPNN), was proposed in \cite{Yang.2019}.
