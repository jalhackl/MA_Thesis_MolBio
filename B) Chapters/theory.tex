...
In the following, the working mechanisms of the applied GNNs will be described. Furthermore, some basic notions which are of particular importance for the performance of the architectures, e.g. norm layers, will be additionally explained in some more detail.
