...
For implementation of the neural network architectures, mostly Pytorch and, for the GNNs, Pytorch Geometric were used. Pytorch Geometric provides the most common GNN models, e.g. GCNs and GINs. These types are usually implemented in two versions.
