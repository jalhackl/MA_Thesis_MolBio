...
1)	Various methods of transforming a graph neural network representation into a fingerprint as similar as possible to the Morgan fingerprint have been conceived.
2)	The performance on various datasets has been explored.
3)	In particular,
