...
\subsection{Combination of fingerprint and GNN}

Similar to \cite{Zhang.2024}, fingerprint and GNN information was also combined.

A simple approach computes both separately and passes both outputs to a final classifier (e.g. a dense neural network layer). 
